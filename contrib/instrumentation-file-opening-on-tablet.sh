...
retry=0
while [ $retry -le 3 ]; do
  if ./gradlew :app:connectedDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.annotation=org.kiwix.kiwixmobile.core.utils.SmokeTest -Dfile.encoding=UTF-8; then
